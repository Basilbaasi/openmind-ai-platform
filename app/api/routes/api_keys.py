...
async def create_key(data: dict, service: ApiKeyService = Depends(get_api_key_service)) -> dict:
...
async def delete_key(key_id: str, service: ApiKeyService = Depends(get_api_key_service)) -> None:
